# Installation von Webots und ROS2
cd ~/Downloads
...
# Trotzdem fehlende Pakete installieren
...
#NEIN: $2 ros2 launch webots_ros2_universal_robot robot_nodes_launch.py
#$3 ros2 launch webots_ros2_universal_robot robot_moveit_nodes_launch.py
...
#### Goal 2,Finger
# XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX funkt !!!!
